...
<p>
For the testing purpose we have stored data in Excel sheet (as the original data given by the organization was in excel sheet)But this can work also with ease by MYSQL database with slight modification in the path of Input. It can also be used in accordance with an SAP database using the SAP Java Connector.
 </p>
 <h4>How it works? </h4>
 <p>
